...
class Transaction {
  constructor(nodeReactionAgent, request) {
    this.uuid = uuidv4();
    this.nodeReactionAgent = nodeReactionAgent;
  ...
  becomeGlobalTransaction() {
    if(this.nodeReactionAgent)
      this.nodeReactionAgent.restoreCurrentTransaction(this);
  }
